    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                p><strong>DOI:</strong> <a href="{{ $articulo->DOI_ARTICULOS }}"
                    target="_blank">{{ $articulo->DOI_ARTICULOS }}</a></p>
                <p><strong>Enlace:</strong> <a href="{{ $articulo->URL_ARTICULOS }}"
                        target="_blank">{{ $articulo->URL_ARTICULOS }}</a></p>
            </div>
