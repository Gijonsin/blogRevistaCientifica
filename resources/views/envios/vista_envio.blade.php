                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Enviar Artículo</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('envios.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="TITULO_ARTICULOS"
                                            name="TITULO_ARTICULOS" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="ISSN_ARTICULOS" class="form-label">ISSN del Artículo</label>
                                                <input type="text" class="form-control" id="ISSN_ARTICULOS"
                                                    name="ISSN_ARTICULOS" maxlength="9" required>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="FECHA_ARTICULOS" class="form-label">Fecha de Publicación</label>
                                                <input type="date" class="form-control" id="FECHA_ARTICULOS"
                                                    name="FECHA_ARTICULOS" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="PALABRAS_ARTICULOS" class="form-label">Palabras Clave (separadas por
                                            comas)</label>
                                        <input type="text" class="form-control" id="PALABRAS_ARTICULOS"
                                            name="PALABRAS_ARTICULOS">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="DOI_ARTICULOS" name="DOI_ARTICULOS"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="URL_ARTICULOS" class="form-label">URL del Artículo</label>
                                        <input type="file" class="form-control" id="URL_ARTICULOS" name="URL_ARTICULOS"
                                            required>
                                    </div>
